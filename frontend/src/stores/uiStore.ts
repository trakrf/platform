...
// Define tab types
export type TabType = 'scan' | 'settings' | 'locate' | 'kits' | 'help' | 'assets' | 'locations' | 'scan-devices' | 'output-devices' | 'live-reads' | 'reports' | 'reports-history' | 'mustering' | 'login' | 'signup' | 'forgot-password' | 'reset-password' | 'create-org' | 'org-members' | 'org-settings' | 'org-geofence-defaults' | 'accept-invite' | 'api-keys' | 'webhooks' | 'admin-orgs' | 'profile';
