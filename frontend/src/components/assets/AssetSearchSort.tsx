...
import { Search, X, ArrowUpDown, QrCode, Loader2 } from 'lucide-react';
import { useAssetStore, useDeviceStore } from '@/stores';
...
export function AssetSearchSort({ className = '' }: AssetSearchSortProps) {
  ...
  // Barcode/QR scanning for search
  ...
  // Sync focus state for hardware trigger scanning
  useEffect(() => {
      ...
      <div className="flex items-center gap-2 flex-1 max-w-md">
        <div className="relative flex-1">
          ...
          <input
            ...
            className={`block w-full pl-10 pr-10 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent ${
              isSearchFocused && isConnected
