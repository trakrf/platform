...
type CreateAssetRequest struct {
	...
	Type                      string               `json:"asset_type,omitempty" validate:"omitempty,oneof=item person inventory" enums:"item,person,inventory" example:"item"`
	...
	CurrentLocation           *string              `json:"current_location_identifier,omitempty" validate:"omitempty,min=1,max=255" example:"WHS-01"`
...
type UpdateAssetRequest struct {
	...
	Type                      *string              `json:"asset_type,omitempty" validate:"omitempty,oneof=item person inventory" enums:"item,person,inventory"`
