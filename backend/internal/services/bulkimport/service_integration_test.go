...
func TestProcessCSVAsync_ParseErrors(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		...
		AddRow("TEST-002", "Invalid Date", "Bad date format", "invalid-date", "2024-12-31", "true").
		AddRow("TEST-003", "Another Valid", "This should work too", "2024-01-01", "2024-12-31", "true")
...
func TestProcessCSVAsync_InsertErrors(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("DUPLICATE-001", "Try Duplicate", "Should fail", "2024-01-01", "2024-12-31", "true").
		AddRow("NEW-001", "New Asset", "Should succeed", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_AllSuccess(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		...
		AddRow("SUCCESS-002", "Asset 2", "Second asset", "2024-01-01", "2024-12-31", "true").
		AddRow("SUCCESS-003", "Asset 3", "Third asset", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestConcurrentUploads(t *testing.T) {
	...
	for i := 0; i < numJobs; i++ {
		csvFactory := testutil.NewCSVFactory().
			AddRow(fmt.Sprintf("CONCURRENT-%d-001", i), fmt.Sprintf("Job %d Asset 1", i), "Test", "2024-01-01", "2024-12-31", "true").
			AddRow(fmt.Sprintf("CONCURRENT-%d-002", i), fmt.Sprintf("Job %d Asset 2", i), "Test", "2024-01-01", "2024-12-31", "true")
		records := csvFactory.Build()
...
func TestJobStatusTracking(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("STATUS-001", "Asset 1", "Test", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestErrorRecovery_DatabaseFailure(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("FAIL-001", "Should Fail", "Invalid org", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_WithValidTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("TAGS-001", "Asset with Tags", "Has RFID tags", "2024-01-01", "2024-12-31", "true", "E280119020004F3D94E00C91,E280119020004F3D94E00C92").
		AddRowWithTags("TAGS-002", "Another Asset", "Single tag", "2024-01-01", "2024-12-31", "true", "E280119020004F3D94E00C93")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_WithEmptyTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("NOTAGS-001", "Asset No Tags", "No tags here", "2024-01-01", "2024-12-31", "true", "").
		AddRowWithTags("NOTAGS-002", "Another No Tags", "Also no tags", "2024-01-01", "2024-12-31", "true", "")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_DuplicateTagsWithinCSV(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("DUP-TAG-001", "First Asset", "Has a tag", "2024-01-01", "2024-12-31", "true", "SAME_TAG_123").
		AddRowWithTags("DUP-TAG-002", "Second Asset", "Same tag", "2024-01-01", "2024-12-31", "true", "SAME_TAG_123")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_MixedWithAndWithoutTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("MIX-001", "Has Tags", "With tags", "2024-01-01", "2024-12-31", "true", "TAG_A,TAG_B").
		AddRowWithTags("MIX-002", "No Tags", "Without tags", "2024-01-01", "2024-12-31", "true", "").
		AddRowWithTags("MIX-003", "More Tags", "With one tag", "2024-01-01", "2024-12-31", "true", "TAG_C")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_WithoutTagsColumn(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("LEGACY-001", "Legacy Asset", "No tags column", "2024-01-01", "2024-12-31", "true").
		AddRow("LEGACY-002", "Another Legacy", "Still no tags", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
