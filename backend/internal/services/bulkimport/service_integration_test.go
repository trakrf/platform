...
func TestProcessCSVAsync_ParseErrors(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("TEST-001", "Valid Asset", "item", "This should work", "2024-01-01", "2024-12-31", "true").
		AddRow("TEST-002", "Invalid Date", "item", "Bad date format", "invalid-date", "2024-12-31", "true").
		AddRow("TEST-003", "Another Valid", "item", "This should work too", "2024-01-01", "2024-12-31", "true")
...
func TestProcessCSVAsync_InsertErrors(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("DUPLICATE-001", "Try Duplicate", "item", "Should fail", "2024-01-01", "2024-12-31", "true").
		AddRow("NEW-001", "New Asset", "item", "Should succeed", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_AllSuccess(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("SUCCESS-001", "Asset 1", "item", "First asset", "2024-01-01", "2024-12-31", "true").
		AddRow("SUCCESS-002", "Asset 2", "item", "Second asset", "2024-01-01", "2024-12-31", "true").
		AddRow("SUCCESS-003", "Asset 3", "item", "Third asset", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestConcurrentUploads(t *testing.T) {
	...
	for i := 0; i < numJobs; i++ {
		csvFactory := testutil.NewCSVFactory().
			AddRow(fmt.Sprintf("CONCURRENT-%d-001", i), fmt.Sprintf("Job %d Asset 1", i), "item", "Test", "2024-01-01", "2024-12-31", "true").
			AddRow(fmt.Sprintf("CONCURRENT-%d-002", i), fmt.Sprintf("Job %d Asset 2", i), "item", "Test", "2024-01-01", "2024-12-31", "true")
		records := csvFactory.Build()
...
func TestJobStatusTracking(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("STATUS-001", "Asset 1", "item", "Test", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
func TestErrorRecovery_DatabaseFailure(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("FAIL-001", "Should Fail", "item", "Invalid org", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
ASSET-TEST-001,Test Asset 1,item,Description 1,2024-01-01,2024-12-31,true
...
func TestProcessCSVAsync_WithValidTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("TAGS-001", "Asset with Tags", "item", "Has RFID tags", "2024-01-01", "2024-12-31", "true", "E280119020004F3D94E00C91,E280119020004F3D94E00C92").
		AddRowWithTags("TAGS-002", "Another Asset", "item", "Single tag", "2024-01-01", "2024-12-31", "true", "E280119020004F3D94E00C93")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_WithEmptyTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("NOTAGS-001", "Asset No Tags", "item", "No tags here", "2024-01-01", "2024-12-31", "true", "").
		AddRowWithTags("NOTAGS-002", "Another No Tags", "item", "Also no tags", "2024-01-01", "2024-12-31", "true", "")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_DuplicateTagsWithinCSV(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("DUP-TAG-001", "First Asset", "item", "Has a tag", "2024-01-01", "2024-12-31", "true", "SAME_TAG_123").
		AddRowWithTags("DUP-TAG-002", "Second Asset", "item", "Same tag", "2024-01-01", "2024-12-31", "true", "SAME_TAG_123")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_MixedWithAndWithoutTags(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRowWithTags("MIX-001", "Has Tags", "item", "With tags", "2024-01-01", "2024-12-31", "true", "TAG_A,TAG_B").
		AddRowWithTags("MIX-002", "No Tags", "item", "Without tags", "2024-01-01", "2024-12-31", "true", "").
		AddRowWithTags("MIX-003", "More Tags", "item", "With one tag", "2024-01-01", "2024-12-31", "true", "TAG_C")
	records := csvFactory.Build()
...
func TestProcessCSVAsync_WithoutTagsColumn(t *testing.T) {
	...
	csvFactory := testutil.NewCSVFactory().
		AddRow("LEGACY-001", "Legacy Asset", "item", "No tags column", "2024-01-01", "2024-12-31", "true").
		AddRow("LEGACY-002", "Another Legacy", "item", "Still no tags", "2024-01-01", "2024-12-31", "true")
	records := csvFactory.Build()
...
ASSET-TAG-001,Tagged Asset 1,item,Has tags,2024-01-01,2024-12-31,true,RFID_001
ASSET-TAG-002,Tagged Asset 2,item,More tags,2024-01-01,2024-12-31,true,"RFID_002,RFID_003"`
