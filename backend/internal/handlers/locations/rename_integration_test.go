...
// pre-TRA-780 F4) — silent-drop under TRA-674 hid bugs in
// read-modify-write integrations. Runtime reject coverage lives in
// TestPatchLocation_ExternalKeyRejected400; this file pins the happy-path
