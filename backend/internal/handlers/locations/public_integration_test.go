...
// internal/cmd/serve/router.go. DefaultRateLimitHeaders, RateLimit and
// SentryContext are intentionally omitted; all other middleware and route
// registrations must stay in sync.
