...
// @Accept json
// @Produce json
// @Param id path int true "Organization id" minimum(1) maximum(9007199254740991)
...
// @Produce json
// @Param id path int true "Organization id" minimum(1) maximum(9007199254740991)
// @Param key_id path int true "API key id (canonical)" minimum(1) maximum(9007199254740991)
